...
// Анимация вращения маленького круга
export const rotateSmall = keyframes`
  100% {
    transform: rotate(1turn);
  }
`;

// Анимация вращения большого круга
export const rotateLarge = keyframes`
  0% {
...
// Анимация гексагонов
export const animateHex = keyframes`
  0% {
...
// Основной контейнер с полупрозрачностью
export const ModalBack = styled.div`
  position: absolute;
  width: 100vw;
  height: 100vh;
  background: rgba(103, 115, 142, 0.6);
  backdrop-filter: blur(5px); /* Веб-версия */
  -webkit-backdrop-filter: blur(5px); /* Safari-поддержка */
  top: 0;
  left: 0;
`;

// Контейнер внешнего кольца
export const HexBorder = styled.div`
  position: absolute;
...
export const Hexagon = styled.div`
  ...
  /* Добавляем различные позиции и анимацию для гексагонов */
  &:nth-child(1) {
